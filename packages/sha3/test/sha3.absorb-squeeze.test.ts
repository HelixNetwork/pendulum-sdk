...
test('Sha3: absorb()/squeeze(), Converter: bytes()/hex()', t => {
	const input = '964b398ecd55793d8ca93e01274efe1377a70c8dc358fdca17cb4e94a9ed7777'
	const expected = 'c2a26a52b0da35baf172d0069cf890f47e351a184b534fffa7d9e4366532d9f9'
