...
/**
 * Checks if input is correct tx consisting of [9A-Z]; optionally validate length
 * @method isHBytes
 *
 * @param {string} hbytes
...
/**
 * Checks if input is correct hash (81 tx) or address with checksum (90 tx)
 *
 * @method isHash
 *
 * @param {string} hash
...
/**
 * Checks if input is correct address or address with checksum (90 tx)
 *
 * @method isAddress
 *
 * @param {string} hash
...
/**
 * Checks that input is valid tag tx.
 *
 * @method isTag
 *
 * @param {string} tag
 ...
 *     'Invalid tx' // Error message
 *   ])
 * } catch (err) {
 *   console.log(err.message) // 'Invalid tx'
 * }
 * ```
 *
 * @method validate
