...
const addresses = ["a".repeat(ADDRESS_HEX_SIZE), "b".repeat(ADDRESS_HEX_SIZE)];
...
const bundle = [
  {
    ...
    lastIndex: 2,
    timestamp: 1522219,
    signatureMessageFragment: "0".repeat(SIGNATURE_MESSAGE_FRAGMENT_HEX_SIZE),
  ...
  t.deepEqual(
    ...
    bundle.map(transaction => ({
      ...
      signatureMessageFragment:
        "abcdef" + "0".repeat(SIGNATURE_MESSAGE_FRAGMENT_HEX_SIZE - 6)
    })),
