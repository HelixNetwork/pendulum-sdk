...
test("isTransfer() returns false for message of invalid txs.", t => {
  const transfer = {
    address: "0ce6dc815205498cde28c048104a366227c39362c06ccff93c29aa8ee1268c1f",
    value: 1234,
    message: "abcdA",
  ...
  t.is(
    isTransfer(transfer),
    false,
    "isTransfer() should return false for message of invalid txs."
  );
});
...
test("isTransfer() returns false for tag of invalid txs.", t => {
  const transfer = {
    address: "0ce6dc815205498cde28c048104a366227c39362c06ccff93c29aa8ee1268c1f",
    value: 1234,
    message: "abcd",
  ...
  t.is(
    isTransfer(transfer),
    false,
    "isTransfer() should return false for tag of invalid txs."
  );
});
