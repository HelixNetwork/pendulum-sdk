...
export const SIGNATURE_MESSAGE_FRAGMENT_TX_HEX_SIZE = 2 * 512;
...
export const HASH_TX_HEX_SIZE = 2 * 32;
...
export const TRANSACTION_TX_HEX_SIZE = 2 * 768;
...
// export const SIGNATURE_MESSAGE_FRAGMENT_TX_HEX_SIZE_BITS = 8 * 1024; // trits 2187 -> 2187 trytes -> 1024 bytes -> 8 * 1024 bits
